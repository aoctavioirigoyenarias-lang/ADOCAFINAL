...
async def create_live_session_with_cloudinary(
    ...
    session = LiveSession(
        ...
        payment_status="liquidado" if (total_price and anticipo_amount and anticipo_amount >= total_price) else ("apartado" if anticipo_amount and anticipo_amount > 0 else "pendiente"),
        is_vip=is_vip,
